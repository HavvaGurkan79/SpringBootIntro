...
public class StudentService {
    ...
    }//yukarda exception yaptigiiz icin tekrar yapmadik
    ...
    public List<Student> findAllEqualsGrade(Integer grade) {//findAll tarzi methodlar icin deger olmsa da [] doner
        //exception atmaz
