...
public class StudentController {
    ...
    @PreAuthorize("hasRole('ADMIN')")//Bu metoda sadece ADMIN yetkisi olanlar kullanabilir
    ...
    return ResponseEntity.ok(student);//ayni islevi yapar--> return new ResponseEntity<>(map, HttpStatus.OK);
    ...
    public ResponseEntity<List<Student>> getStudentByLastName(@RequestParam("lastName") String lastName) {
        List<Student> list = (List<Student>) studentService.findStudent(lastName);
