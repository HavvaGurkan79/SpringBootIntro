...
@Repository//opsiyonel-->JpaRepository'den extend oldugu icin anlasiliyor zaten
public interface StudentRepository extends JpaRepository<Student,Long> {
    ...
    Optional<StudentDTO> findStudentDTOById(@Param("id")Long id);//null gelme ihtimali oldugu icin optional
}
